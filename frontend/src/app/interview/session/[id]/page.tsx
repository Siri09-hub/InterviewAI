...
import CandidateVoiceInput from "@/components/CandidateVoiceInput";
...
export default function InterviewSessionPage() {
  ...
  // Prevent duplicate save/submit requests
  const savingRef =
    useRef(false);
  ...
  function updateAnswer(
    ...
    // Typing means the current answer
    // is now considered a text answer.
    setAnswerSources(
      (previous) => {
        const updated = [
          ...previous,
                ...
                currentQuestion.question_type ===
                  ...
                  <div className="mt-8">
                    ...
                    <textarea
                      ...
                      className="w-full rounded-xl border border-slate-300 p-4 text-slate-800 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100 disabled:cursor-not-allowed disabled:bg-slate-50"
                    />
